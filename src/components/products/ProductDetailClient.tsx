...
import { ChevronRight, ArrowLeft, FileText, FlaskConical, Mail, Phone, ExternalLink, Tag, Activity, Database, FileDown } from "lucide-react";
import type { ProductItem } from "@/data/products";
import { useI18n } from "@/lib/i18n";

export default function ProductDetailClient({ product, related, category }: { product: ProductItem; related: ProductItem[]; category: { id: string; title: string; titleEn: string; description: string; descriptionEn: string } }) {
